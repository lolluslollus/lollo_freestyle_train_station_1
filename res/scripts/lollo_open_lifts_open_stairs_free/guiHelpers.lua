...
-- local _conConfigWindowId = 'lollo_freestyle_train_station_con_config_window'
local _warningWindowWithGotoId = 'lollo_freestyle_train_station_warning_window_with_goto'
-- local _warningWindowWithStateId = 'lollo_freestyle_train_station_warning_window_with_state'
