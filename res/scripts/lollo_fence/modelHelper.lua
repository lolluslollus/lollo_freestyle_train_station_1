...
privateValues.defaults = {
    ...
    lolloFenceAssets_numWalls = 0,
    lolloFenceAssets_isSkewed = 0,
...
local privateFuncs = {
    ...
    getModels = function(isTunnel)
        ...
        if isTunnel then
            ...
            add('lollo_freestyle_train_station/platformWalls/arched/copper_large_rivets_wall_tunnel_2_5m.mdl', 'ui/lollo_freestyle_train_station/wallCopperWLargeRivets.tga', _("WallCopperWLargeRivetsName"))
            add('lollo_freestyle_train_station/platformWalls/arched/iron_large_rivets_wall_tunnel_2_5m.mdl', 'ui/lollo_freestyle_train_station/wallIronWLargeRivets.tga', _("WallIronWLargeRivetsName"))
            add('lollo_freestyle_train_station/platformWalls/arched/metal_large_rivets_wall_tunnel_2_5m.mdl', 'ui/lollo_freestyle_train_station/wallMetalWLargeRivets.tga', _("WallMetalWLargeRivetsName"))
            ...
            add('lollo_freestyle_train_station/platformWalls/arched/tiles_green_wall_tunnel_2_5m.mdl', 'ui/lollo_freestyle_train_station/wallTiledGreen.tga', _("wallTiledGreenName"))
            ...
            add('lollo_freestyle_train_station/platformWalls/arched/iron_glass_copper_wall_tunnel_2_5m.mdl', 'ui/lollo_freestyle_train_station/wallIronGlassCopper.tga', _("WallIronGlassCopperName"))
            ...
            add('lollo_freestyle_train_station/platformWalls/copper_large_rivets/wall_low_5m.mdl', 'ui/lollo_freestyle_train_station/wallCopperWLargeRivets.tga', _("WallCopperWLargeRivetsName"))
            add('lollo_freestyle_train_station/platformWalls/iron_large_rivets/wall_low_5m.mdl', 'ui/lollo_freestyle_train_station/wallIronWLargeRivets.tga', _("WallIronWLargeRivetsName"))
            add('lollo_freestyle_train_station/platformWalls/metal_large_rivets/wall_low_5m.mdl', 'ui/lollo_freestyle_train_station/wallMetalWLargeRivets.tga', _("WallMetalWLargeRivetsName"))
            ...
            add('lollo_freestyle_train_station/platformWalls/tiled_green/platformWall_low_5m.mdl', 'ui/lollo_freestyle_train_station/wallTiledGreen.tga', _("wallTiledGreenName"))
            ...
            add('lollo_freestyle_train_station/platformWalls/arco_concrete_rough/wall_low_5m.mdl', 'ui/lollo_freestyle_train_station/arco_concrete_rough_wall.tga', _("WallArcoConcreteRough"))
            add('lollo_freestyle_train_station/platformWalls/arco_concrete_rough_light/wall_low_5m.mdl', 'ui/lollo_freestyle_train_station/arco_concrete_rough_light_wall.tga', _("WallArcoConcreteRoughLight"))
    ...
    getWallBehindModels = function(isWallTall, isWallBehindThick)
        ...
        if isWallBehindThick then
            if isWallTall then
                ...
                add('lollo_freestyle_train_station/platformWalls/behind/concrete_light_wall_5m_2m_thick.mdl', 'ui/lollo_freestyle_train_station/wallBehindConcreteLightPlain.tga', _("WallConcreteLightPlainName"))
            else
                add(nil, 'ui/lollo_freestyle_train_station/none.tga', _('NoWallName'))
                ...
                add('lollo_freestyle_train_station/platformWalls/behind/concrete_light_wall_low_5m_2m_thick.mdl', 'ui/lollo_freestyle_train_station/wallBehindConcreteLightPlain.tga', _("WallConcreteLightPlainName"))
            end
        else
            if isWallTall then
                add(nil, 'ui/lollo_freestyle_train_station/none.tga', _('NoWallName'))
                ...
                add('lollo_freestyle_train_station/platformWalls/behind/concrete_light_wall_5m.mdl', 'ui/lollo_freestyle_train_station/wallBehindConcreteLightPlain.tga', _("WallConcreteLightPlainName"))
            else
                add(nil, 'ui/lollo_freestyle_train_station/none.tga', _('NoWallName'))
                ...
                add('lollo_freestyle_train_station/platformWalls/behind/concrete_light_wall_low_5m.mdl', 'ui/lollo_freestyle_train_station/wallBehindConcreteLightPlain.tga', _("WallConcreteLightPlainName"))
            end
        end
        return results
    end,
...
return {
    ...
    getConParams = function ()
        ...
        return {
            ...
            {
                defaultIndex = privateValues.defaults.lolloFenceAssets_isSkewed,
                key = 'lolloFenceAssets_isSkewed',
            ...
            },
            {
                ...
                name = _('NumWalls'),
                uiType = 'SLIDER',
                values = privateFuncs.getNumWallsDisplayValues(),
            },
            {
