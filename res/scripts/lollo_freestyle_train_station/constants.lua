...
local constants = {
    ...
    cargoPlatformStyles = {
        cargo_earth = {moduleFileName = 'station/rail/lollo_freestyle_train_station/platformStyles/platformStyleCargoEarth.module'},
        cargo_gravel = {moduleFileName = 'station/rail/lollo_freestyle_train_station/platformStyles/platformStyleCargoGravel.module'},
    },
    ...
    subwayConFileNames = {
        ['lollo_freestyle_train_station/subways/subway.con'] = true,
        ['lollo_freestyle_train_station/subways/subwayHollowayMedium.con'] = true,
        ['lollo_freestyle_train_station/subways/subwayHollowayLarge.con'] = true,
        ['lollo_freestyle_train_station/subways/subwayClaphamLarge.con'] = true,
        ['lollo_freestyle_train_station/subways/subwayClaphamMedium.con'] = true,
        ['lollo_freestyle_train_station/subways/subwayClaphamSmall.con'] = true,
        ['station/rail/lollo_freestyle_train_station/subway.con'] = true, -- OBSOLETE, it is here for compatibility with older code
        ['station/rail/lollo_freestyle_train_station/subwayHollowayMedium.con'] = true, -- OBSOLETE, it is here for compatibility with older code
        ['station/rail/lollo_freestyle_train_station/subwayHollowayLarge.con'] = true, -- OBSOLETE, it is here for compatibility with older code
    ...
    platformWallInTunnelModuleType = 'freestyleTrainStationWallInTunnel',
    trackWallInTunnelModuleType = 'freestyleTrainStationTrackWallInTunnel',
    ...
    removeTerminalDecoModuleType = 'freestyleTrainStationRemoveTerminalDeco',
    removeTerminalDecoAndBinsModuleType = 'freestyleTrainStationRemoveTerminalDecoAndBins',
    removeTerminalDecoAndBinsAndSignsModuleType = 'freestyleTrainStationRemoveTerminalDecoAndBinsAndSigns',
    removeTerminalDecoNoneModuleType = 'freestyleTrainStationRemoveTerminalDecoNone',
    ...
    cargoPlatformStyleModuleType = 'freestyleTrainStationCargoPlatformStyle',
    passengersPlatformStyleModuleType = 'freestyleTrainStationPassengersPlatformStyle',
	...
	idBases = {
        ...
        removeDecoSlotId = 74000000,
        platformWallInTunnelSlotId = 75000000,
        trackWallInTunnelSlotId = 76000000,
        trackWallEndSlotId = 77000000,
        trackWallEndInTunnelSlotId = 78000000,
