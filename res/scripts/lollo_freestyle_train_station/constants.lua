...
local constants = {
    ...
    liftModuleType = 'freestyleTrainStationLift',
	...
	idBases = {
        ...
        flatArea5x5SlotId = 3000000,
        flatArea10x5SlotId = 4000000,
        flatArea10x10SlotId = 5000000,
        liftSlotId = 600000,
        slopedArea1x5SlotId = 7000000,
        slopedArea1x10SlotId = 8000000,
        slopedArea1x20SlotId = 9000000,
