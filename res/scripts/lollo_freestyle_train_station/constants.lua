...
local constants = {
    ...
    platformRoofPillar2_5MModelFileName = 'lollo_freestyle_train_station/roofs/platformRoofPillar_2_5m.mdl',
    platformRoofCeiling2_5MModelFileName = 'lollo_freestyle_train_station/roofs/platformRoofCeiling_2_5m.mdl',
    platformRoofPillar5MModelFileName = 'lollo_freestyle_train_station/roofs/platformRoofPillar_5m.mdl',
    platformRoofCeiling5MModelFileName = 'lollo_freestyle_train_station/roofs/platformRoofCeiling_5m.mdl',
