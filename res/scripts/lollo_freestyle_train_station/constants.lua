...
local constants = {
    ...
    era_a_openStairsUpModelId = 'lollo_freestyle_train_station/open_stairs/era_c_open_stairsUp.mdl',
    era_b_openStairsUpModelId = 'lollo_freestyle_train_station/open_stairs/era_c_open_stairsUp.mdl',
    era_c_openStairsUpModelId = 'lollo_freestyle_train_station/open_stairs/era_c_open_stairsUp.mdl',
