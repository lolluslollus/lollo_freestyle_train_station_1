...
local constants = {
    ...
    passengersTerminalModuleType = 'freestyleTrainStationPassengersTerminal',
    ...
    passengersTerminalModuleFileName = 'station/rail/lollo_freestyle_train_station/passengersTerminal.module',
	...
	trackSpacing = {20, 20, 2, 2}, -- the smaller, the less the risk of collision. Too small, problems removing the module. x is length, y is width.
	idBases = {
