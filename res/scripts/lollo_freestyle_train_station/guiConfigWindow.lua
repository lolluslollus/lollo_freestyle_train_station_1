...
return {
    ...
    new = function(configLayoutIdPrefix, warningWindowWithGotoId, texts, extraHeight4Title, extraHeight4Param, windowXShift, windowYShift)
        privateData.conConfigLayoutIdPrefix = configLayoutIdPrefix
        privateData.warningWindowWithGotoId = warningWindowWithGotoId
        privateData.texts = texts
        privateData.extraHeight4Title = extraHeight4Title or samplePrivateData.extraHeight4Title
        privateData.extraHeight4Param = extraHeight4Param or samplePrivateData.extraHeight4Param
        privateData.windowXShift = windowXShift or samplePrivateData.windowXShift
        privateData.windowYShift = windowYShift or samplePrivateData.windowYShift
        return public
    end
}
