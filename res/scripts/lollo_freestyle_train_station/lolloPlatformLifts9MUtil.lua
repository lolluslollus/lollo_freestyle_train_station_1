        ...
        for h = 5, height, 5 do
            ...
            if era == _moduleHelpers.eras.era_a.prefix then
                results[#results + 1] = {
                    ...
                    mesh = h == 5 and 'lollo_freestyle_train_station/lift/era_a_platform_lift_9x5x5_top_level.msh' or 'lollo_freestyle_train_station/lift/era_a_lift9x5x5level_deco.msh',
                    transf = wallTransf
                }
            else
                results[#results + 1] = {
