    ...
    platforms = {
        addPlatform = function(result, tag, slotId, params, nTerminal)
            ...
            for ii = 1, #params.terminals[nTerminal].centrePlatformsFineRelative do
                ...
                print('HUMP cpf.posTanX2 =') debugPrint(cpf.posTanX2)
                print('HUMP myTransf =') debugPrint(myTransf)
-- LOLLO TODO platforms and sloped areas look wrong on humps: they are full of cuts
-- This does not depend on isPlatformLeft, it seems.
-- On humps, cpf.posTanX2 can be as high as 1.25, for example:
--[[
posTanX2 =
{
  {
    { -1.3500590163823, -0.036953240590492, -0.49369418050316, },
    { 0.99919005142623, 0.027354899227913, 0.029511872510543, },
  },
  {
    { -0.098013042487807, -0.002677526578168, -0.45746026877994, },
    { 0.99922428480445, 0.027353758362093, 0.028330205796916, },
  },
}
]]
-- This is a basic error and it seems to come from the initial creation of the fine lanes.
-- In particular, from stationHelpers.getCentralEdgePositions_OnlyOuterBounds()
-- it received:
--[[
{
  {
    ...
    posTanX2 = {
      {
        { 96.944892883301, 684.10473632813, 56.14391708374, },
        { 6.94162940979, 0.19010773301125, 0.31464478373528, },
      },
      {
        { 103.88204956055, 684.29473876953, 56.414089202881, },
        { 6.9450469017029, 0.19018466770649, 0.22697106003761, },
      },
    },
    trackType = 20,
  ...
  },
  {
    ...
    posTanX2 = {
      {
        { 103.88204956055, 684.29473876953, 56.414089202881, },
        { 4.9876294136047, 0.13657999038696, 0.15421308577061, },
      },
      {
        { 109.86787414551, 684.45861816406, 56.578479766846, },
        { 4.9875664710999, 0.13659618794918, 0.11138851940632, },
      },
    },
    trackType = 20,
    trackTypeName = "lollo_freestyle_train_station/era_c_passenger_platform_5m.lua",
  ...
  },
  {
    ...
    posTanX2 = {
      {
        { 109.86787414551, 684.45861816406, 56.578479766846, },
        { 4.9883551597595, 0.13661772012711, 0.11140441894531, },
      },
      {
        { 114.85623931885, 684.59521484375, 56.669219970703, },
        { 4.9883642196655, 0.13662470877171, 0.070376686751842, },
      },
    },
    trackType = 20,
    trackTypeName = "lollo_freestyle_train_station/era_c_passenger_platform_5m.lua",
...
{
  {
    ...
    posTanX2 = {
      {
        { 96.944892883301, 684.10473632813, 56.14391708374, },
        { 0.99860064369428, 0.027348291496021, 0.045263793991935, },
      },
      {
        { 97.943181921663, 684.13207734648, 56.188237995759, },
        { 0.99868278948359, 0.027352912111076, 0.043410876382869, },
      },
    },
    trackType = 20,
    trackTypeName = "lollo_freestyle_train_station/era_c_passenger_platform_5m.lua",
  ...
  },
  {
    ...
    posTanX2 = {
      ...
      {
        { 98.940994971661, 684.15940724241, 56.230688286544, },
        { 0.99876105840682, 0.027356515555142, 0.041568849716732, },
      },
    },
    trackType = 20,
    trackTypeName = "lollo_freestyle_train_station/era_c_passenger_platform_5m.lua",
  ...
  },
  {
    ...
    posTanX2 = {
      ...
      {
        { 99.938552866747, 684.18673115171, 56.271290670162, },
        { 0.99883546860263, 0.027359100122139, 0.039738977111559, },
      },
    },
    trackType = 20,
    trackTypeName = "lollo_freestyle_train_station/era_c_passenger_platform_5m.lua",
  ...
  },
  {
    ...
    posTanX2 = {
      ...
      {
        { 100.93607644037, 684.21405421018, 56.310067860678, },
        { 0.99890604038034, 0.027360665397357, 0.037922506255316, },
      },
    },
    trackType = 20,
    trackTypeName = "lollo_freestyle_train_station/era_c_passenger_platform_5m.lua",
  ...
  },
  {
    ...
    posTanX2 = {
      ...
      {
        { 101.93378652599, 684.2413815536, 56.347042572161, },
        { 0.9989728031724, 0.027361212450738, 0.036120666869574, },
      },
    },
    trackType = 20,
    trackTypeName = "lollo_freestyle_train_station/era_c_passenger_platform_5m.lua",
  ...
  },
  {
    ...
    posTanX2 = {
      ...
      {
        { 102.93190395705, 684.26871831776, 56.382237518676, },
        { 0.9990357952929, 0.027360743828928, 0.034334667911871, },
      },
    },
    trackType = 20,
    trackTypeName = "lollo_freestyle_train_station/era_c_passenger_platform_5m.lua",
  ...
  },
  {
    ...
    posTanX2 = {
      ...
      {
        { 103.93093971655, 684.29607755371, 56.415599015002, },
        { 0.99915046324784, 0.027360016583078, 0.030818521771846, },
      },
    },
    trackType = 20,
    trackTypeName = "lollo_freestyle_train_station/era_c_passenger_platform_5m.lua",
  ...
  },
  {
    ...
    posTanX2 = {
      ...
      {
        { 105.04359485325, 684.32654163246, 56.449140673623, },
        { 0.99919005142623, 0.027354899227913, 0.029511872510543, },
      },
    },
    trackType = 20,
  ...
  },
  {
    ...
    posTanX2 = {
      ...
      {
        { 106.29564082714, 684.36081734647, 56.485374585346, },
        { 0.99922428480445, 0.027353758362093, 0.028330205796916, },
      },
    },
    trackType = 20,
  ...
  },
  {
    ...
    posTanX2 = {
      ...
      {
        { 107.59074478989, 684.39627097604, 56.521252212332, },
        { 0.99926157894948, 0.027355478709285, 0.026981004799118, },
      },
    },
    trackType = 20,
    trackTypeName = "lollo_freestyle_train_station/era_c_passenger_platform_5m.lua",
  ...
  },
  {
    ...
    posTanX2 = {
      ...
      {
        { 108.83257389315, 684.43026880145, 56.553725016742, },
        { 0.99930964473082, 0.027360478545774, 0.02513241257258, },
      },
    },
    trackType = 20,
    trackTypeName = "lollo_freestyle_train_station/era_c_passenger_platform_5m.lua",
  ...
  },
  {
    ...
    posTanX2 = {
      ...
      {
        { 109.92520499735, 684.46018829366, 56.57975736201, },
        { 0.99937832930582, 0.027369980752467, 0.022222490128572, },
      },
    },
    trackType = 20,
    trackTypeName = "lollo_freestyle_train_station/era_c_passenger_platform_5m.lua",
  ...
  },
  {
    ...
    posTanX2 = {
      ...
      {
        { 110.92465587866, 684.48755788933, 56.601142693757, },
        { 0.99941424772366, 0.027366617552854, 0.020548228407185, },
      },
    },
    trackType = 20,
    trackTypeName = "lollo_freestyle_train_station/era_c_passenger_platform_5m.lua",
  ...
  },
  {
    ...
    posTanX2 = {
      ...
      {
        { 111.92410788483, 684.51492435997, 56.620860188923, },
        { 0.99944702625927, 0.027365550524885, 0.018888312417077, },
      },
    },
    trackType = 20,
    trackTypeName = "lollo_freestyle_train_station/era_c_passenger_platform_5m.lua",
  ...
  },
  {
    ...
    posTanX2 = {
      ...
      {
        { 112.92356048659, 684.54229007354, 56.638924358361, },
        { 0.99947673637446, 0.027366781868915, 0.017242757795448, },
      },
    },
    trackType = 20,
    trackTypeName = "lollo_freestyle_train_station/era_c_passenger_platform_5m.lua",
  ...
  },
  {
    ...
    posTanX2 = {
      ...
      {
        { 113.92301315471, 684.56965739801, 56.655349712923, },
        { 0.99950344897473, 0.027370313733528, 0.015611579476242, },
      },
    },
    trackType = 20,
    trackTypeName = "lollo_freestyle_train_station/era_c_passenger_platform_5m.lua",
  ...
  },
  {
    ...
    posTanX2 = {
      {
        { 113.92301315471, 684.56965739801, 56.655349712923, },
        { 0.93327398749097, 0.025556692038603, 0.014577119312364, },
      },
      {
        { 114.85623931885, 684.59521484375, 56.669219970703, },
        { 0.93322581872727, 0.025559822837154, 0.013166107810328, },
      },
    },
    trackType = 20,
    trackTypeName = "lollo_freestyle_train_station/era_c_passenger_platform_5m.lua",
