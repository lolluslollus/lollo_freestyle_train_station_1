...
utils.getModel4StationTube = function(nSegments, isCompressed, eraPrefix)
    if (not(nSegments) or nSegments < 1) then nSegments = 1 end
    ...
    local _lod0_skinMaterials_rep, _lod0_skinMaterials_side, _lod0_skinMaterials_side_no_railing, _lod1_materials = getDynamicProps(eraPrefix)
    local _lod0_skinMaterials_rep_tube, _lod0_skinMaterials_side_tube, _lod0_skinMaterials_side_no_railing_tube, _lod1_materials_tube = getDynamicProps_Tube(eraPrefix)
