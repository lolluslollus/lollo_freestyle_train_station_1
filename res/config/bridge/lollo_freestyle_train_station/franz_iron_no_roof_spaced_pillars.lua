...
function data()
	...
	local railing = {
		railingDir .. 'railing_iron_rep_side.mdl',
		railingDir .. 'railing_iron_rep_side.mdl',
		railingDir .. 'railing_iron_rep_side_no_side.mdl',
		railingDir .. 'railing_iron_rep_rep.mdl',
		railingDir .. 'railing_iron_rep_rep.mdl',
	}
	...
	return pedestrianBridgeUtil.getData4CementGlassBridge(
		_('FranzBridgeIronNoRoofSpacedPillars'),
		config,
		48, 192, 96
	)
end
