function data()
	...
	t.name = _("EraCPassengerPlatform5MAutoSplitName")
	t.desc = _("EraCPassengerPlatform5MAutoSplitDesc")
	t.categories  = { _constants.passengerPlatformTracksCategory }
	t.icon = "ui/lollo_freestyle_train_station/era_c_passenger_platform_5m_auto_split.tga"
