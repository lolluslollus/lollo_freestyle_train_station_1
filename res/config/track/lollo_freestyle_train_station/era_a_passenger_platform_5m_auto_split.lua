function data()
	...
	t.name = _("EraAPassengerPlatform5MAutoSplitName")
	t.desc = _("EraAPassengerPlatform5MAutoSplitDesc")
	t.categories  = { _constants.passengerPlatformTracksCategory }
	t.icon = "ui/lollo_freestyle_train_station/era_a_passenger_platform_5m_auto_split.tga"
