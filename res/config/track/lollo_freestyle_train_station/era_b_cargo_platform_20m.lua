function data()
	...
	t.name = _("EraBCargoPlatform20MName")
	t.desc = _("EraBCargoPlatform20MDesc")
	t.categories  = { _constants.cargoPlatformTracksCategory }
	t.icon = "ui/lollo_freestyle_train_station/era_b_cargo_platform_20m.tga"
	...
	t.sleeperModel = "lollo_freestyle_train_station/railroad/track/era_b_cargo_sleeper_20m_wide.mdl"
	t.trackStraightModel = {
		'lollo_freestyle_train_station/railroad/track/era_b_cargo_platform_2m_base_20m_wide.mdl', --"railroad/tracks/2m_base.mdl",
		'lollo_freestyle_train_station/railroad/track/era_b_cargo_platform_4m_base_20m_wide.mdl', --"railroad/tracks/4m_base.mdl",
		'lollo_freestyle_train_station/railroad/track/era_b_cargo_platform_8m_base_20m_wide.mdl', --"railroad/tracks/8m_base.mdl",
		'lollo_freestyle_train_station/railroad/track/era_b_cargo_platform_16m_base_20m_wide.mdl', --"railroad/tracks/16m_base.mdl",
	}
