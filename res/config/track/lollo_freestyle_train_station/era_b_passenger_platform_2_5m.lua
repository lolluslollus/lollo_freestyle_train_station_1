function data()
	...
	t.name = _("EraBPassengerPlatform2_5MName")
	t.desc = _("EraBPassengerPlatform2_5MDesc")
	t.categories  = { _constants.passengerPlatformTracksCategory }
	t.icon = "ui/lollo_freestyle_train_station/era_b_passenger_platform_2_5m.tga"
	...
	t.sleeperModel = "lollo_freestyle_train_station/railroad/track/era_b_passenger_sleeper_2_5m_wide.mdl"
	t.trackStraightModel = {
		'lollo_freestyle_train_station/railroad/track/era_b_passenger_platform_2m_base_2_5m_wide.mdl', --"railroad/tracks/2m_base.mdl",
		'lollo_freestyle_train_station/railroad/track/era_b_passenger_platform_4m_base_2_5m_wide.mdl', --"railroad/tracks/4m_base.mdl",
		'lollo_freestyle_train_station/railroad/track/era_b_passenger_platform_8m_base_2_5m_wide.mdl', --"railroad/tracks/8m_base.mdl",
		'lollo_freestyle_train_station/railroad/track/era_b_passenger_platform_16m_base_2_5m_wide.mdl', --"railroad/tracks/16m_base.mdl",
	}
