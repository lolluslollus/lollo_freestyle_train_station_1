...
- After a while or after terraforming, the objects surrounding your station might throw collision errors whenever you try to configure the station. This is an old game problem and it happens with other stations, too. To get past it, start removing pedestrian bridges that snap into the station and add them back once you are done. If this does not help, do the same with adjoining tracks. If you still have no luck, patiently look for the guilty street, building or asset and remove it, then add it back once you are done.
			...
			["FranzBridgeCopperNoRoof"] = "Copper bridge",
			["FranzBridgeCopperNoRoofNoPillars"] = "Copper bridge with no pillars",
			["FranzBridgeCopperNoRoofSpacedPillars"] = "Copper bridge with spaced pillars",
			["FranzBridgeIronNoRoof"] = "Plain iron bridge",
			["FranzBridgeIronNoRoofNoPillars"] = "Plain iron bridge with no pillars",
			["FranzBridgeIronNoRoofSpacedPillars"] = "Plain iron bridge with spaced pillars",
			["FranzBridgeMetalNoRoof"] = "Lacked iron bridge",
			["FranzBridgeMetalNoRoofNoPillars"] = "Lacked iron bridge with no pillars",
			["FranzBridgeMetalNoRoofSpacedPillars"] = "Lacked iron bridge with spaced pillars",
			["FranzBridgeCopperNoRoofNoSides"] = "Copper bridge with no railing, compatible with 2.5 m platforms",
			["FranzBridgeCopperNoRoofNoPillarsNoSides"] = "Copper bridge with no pillars and no railing, compatible with 2.5 m platforms",
			["FranzBridgeCopperNoRoofSpacedPillarsNoSides"] = "Copper bridge with spaced pillars and no railing, compatible with 2.5 m platforms",
			["FranzBridgeIronNoRoofNoSides"] = "Plain iron bridge with no railing, compatible with 2.5 m platforms",
			["FranzBridgeIronNoRoofNoPillarsNoSides"] = "Plain iron bridge with no pillars and no railing, compatible with 2.5 m platforms",
			["FranzBridgeIronNoRoofSpacedPillarsNoSides"] = "Plain iron bridge with spaced pillars and no railing, compatible with 2.5 m platforms",
			["FranzBridgeMetalNoRoofNoSides"] = "Lacked iron bridge with no railing, compatible with 2.5 m platforms",
			["FranzBridgeMetalNoRoofNoPillarsNoSides"] = "Lacked iron bridge with no pillars and no railing, compatible with 2.5 m platforms",
			["FranzBridgeMetalNoRoofSpacedPillarsNoSides"] = "Lacked iron bridge with spaced pillars and no railing, compatible with 2.5 m platforms",
...
- Nach einer Weile wird sich das Gebiet um Ihren Bahnhof herum entwickelt haben und möglicherweise Kollisionsfehler verursachen, wenn du versuchst, den Bahnhof zu konfigurieren. Dieses alte Problem betrifft auch andere Bahnhöfe. Suche geduldig erst nach der schuldigen Straße, dann nach dem Gleis, dann nach dem Gebäude oder der Anlage und entferne sie.
			...
			["CementBridgeSpacedPillarsNoSides"] = "Betonbrücke mit Abstandspfeilern und ohne Geländer, kompatibel mit 2,5 m Bahnsteigen",
			["FranzBridgeCopperNoRoof"] = "Kupferbrücke",
			["FranzBridgeCopperNoRoofNoPillars"] = "Kupferbrücke ohne Pfeiler",
			["FranzBridgeCopperNoRoofSpacedPillars"] = "Kupferbrücke mit Abstandspfeilern",
			["FranzBridgeIronNoRoof"] = "Einfache Eisenbrücke",
			["FranzBridgeIronNoRoofNoPillars"] = "Einfache Eisenbrücke ohne Pfeiler",
			["FranzBridgeIronNoRoofSpacedPillars"] = "Einfache Eisenbrücke mit Abstandspfeilern",
			["FranzBridgeMetalNoRoof"] = "Lackierte Eisenbrücke",
			["FranzBridgeMetalNoRoofNoPillars"] = "Lackierte Eisenbrücke ohne Pfeiler",
			["FranzBridgeMetalNoRoofSpacedPillars"] = "Lackierte Eisenbrücke mit Abstandspfeilern",
			["FranzBridgeCopperNoRoofNoSides"] = "Kupferbrücke ohne Geländer, kompatibel mit 2,5 m Bahnsteigen",
			["FranzBridgeCopperNoRoofNoPillarsNoSides"] = "Kupferbrücke ohne Pfeiler und Geländer, kompatibel mit 2,5 m Bahnsteigen",
			["FranzBridgeCopperNoRoofSpacedPillarsNoSides"] = "Kupferbrücke mit Abstandspfeilern und ohne Geländer, kompatibel mit 2,5 m Bahnsteigen",
			["FranzBridgeIronNoRoofNoSides"] = "Einfache Eisenbrücke ohne Geländer, kompatibel mit 2,5 m Bahnsteigen",
			["FranzBridgeIronNoRoofNoPillarsNoSides"] = "Einfache Eisenbrücke ohne Pfeiler und Geländer, kompatibel mit 2,5 m Bahnsteigen",
			["FranzBridgeIronNoRoofSpacedPillarsNoSides"] = "Einfache Eisenbrücke mit Abstandspfeilern und ohne Geländer, kompatibel mit 2,5 m Bahnsteigen",
			["FranzBridgeMetalNoRoofNoSides"] = "Lackierte Eisenbrücke ohne Geländer, kompatibel mit 2,5 m Bahnsteigen",
			["FranzBridgeMetalNoRoofNoPillarsNoSides"] = "Lackierte Eisenbrücke ohne Pfeiler und Geländer, kompatibel mit 2,5 m Bahnsteigen",
			["FranzBridgeMetalNoRoofSpacedPillarsNoSides"] = "Lackierte Eisenbrücke mit Abstandspfeilern und ohne Geländer, kompatibel mit 2,5 m Bahnsteigen",
			["IronBridgeNoPillarsNoSides"] = "Tiefe Eisenbrücke ohne Pfeiler und ohne Geländer, kompatibel mit 2,5 m Bahnsteigen",
			["IronBridgeNormalPillarsNoSides"] = "Tiefe Eisenbrücke ohne Geländer, kompatibel mit 2,5 m Bahnsteigen",
			["IronBridgeSpacedPillarsNoSides"] = "Tiefe Eisenbrücke mit Abstandspfeilern und ohne Geländer, kompatibel mit 2,5 m Bahnsteigen",
