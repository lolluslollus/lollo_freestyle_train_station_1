function data()
	return {
		en = {
			...
			["FlatStairsDesc"] = "Stairs, 2 m. Adjust their height with <m> and <n>.",
			["FlatStairsSmoothName"] = "Smooth stairs",
			["FlatStairsSmoothDesc"] = "Smooth stairs leading outside, 2 m. Adjust their height with <m> and <n>.",
			["FlatStairsSteepName"] = "Steep stairs",
			["FlatStairsSteepDesc"] = "Steep stairs leading outside, 2 m. Adjust their height with <m> and <n>.",
			...
			["FlatCargoArea10x5Desc"] = "Flat side area with stairs leading outside, 10x5 m, cargo style. Good for plopping assets. Adjust its height with <m> and <n>.",
			["FlatCargoArea10x10Name"] = "10x10 flat side area with stairs, cargo style",
			["FlatCargoArea10x10Desc"] = "Flat side area with stairs leading outside, 10x10 m, cargo style. Good for plopping assets. Adjust its height with <m> and <n>.",
			...
			["FlatPassengerArea10x5Desc"] = "Flat side area with stairs leading outside, 10x5 m, passenger style. Good for plopping assets. Adjust its height with <m> and <n>.",
			["FlatPassengerArea10x10Name"] = "10x10 flat side area with stairs, passenger style",
			["FlatPassengerArea10x10Desc"] = "Flat side area with stairs leading outside, 10x10 m, passenger style. Good for plopping assets. Adjust its height with <m> and <n>.",
