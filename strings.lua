function data()
	...
	return {
		en = {
			...
			["TrackCrossingDesc"] = "It connects to one platform and it can connect to the road network or to a twin opposite.",
			["TrackCrossingTwoStairsName"] = "Track crossing for a single track",
			["TrackCrossingTwoStairsDesc"] = "It tries to connect to two opposite platforms and it can connect to the road network.",
