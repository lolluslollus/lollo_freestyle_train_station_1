function data()
	...
	return {
		en = {
			...
			["AxialCargoRampFlatDesc"] = "Cargo exit, 2 m.",
			["AxialCargoRampUpSmoothName"] = "Smooth cargo ramp up",
			["AxialCargoRampUpSmoothDesc"] = "Smooth cargo ramp leading outside and up, 2 m.",
			["AxialCargoRampUpSteepName"] = "Steep cargo ramp up",
			["AxialCargoRampUpSteepDesc"] = "Steep cargo ramp leading outside and up, 2 m.",
			["AxialCargoRampDownSmoothName"] = "Smooth cargo ramp down",
			["AxialCargoRampDownSmoothDesc"] = "Smooth cargo ramp leading outside and down, 2 m.",
			["AxialCargoRampDownSteepName"] = "Steep cargo ramp down",
			["AxialCargoRampDownSteepDesc"] = "Steep cargo ramp leading outside and down, 2 m.",
			["AxialPassengerStairsFlatName"] = "Flat passenger exit",
			["AxialPassengerStairsFlatDesc"] = "Flat passenger exit, 2 m. It connects automatically to nearby platforms or exits.",
			["AxialPassengerStairsUpSmoothName"] = "Exit with smooth passenger stairs up",
			["AxialPassengerStairsUpSmoothDesc"] = "Smooth passenger stairs leading outside and up, 2 m. It connects automatically to nearby platforms or exits.",
			["AxialPassengerStairsUpSteepName"] = "Exit with steep passenger stairs up",
			["AxialPassengerStairsUpSteepDesc"] = "Steep passenger stairs leading outside and up, 2 m. It connects automatically to nearby platforms or exits.",
			["AxialPassengerStairsDownSmoothName"] = "Exit with smooth passenger stairs down",
			["AxialPassengerStairsDownSmoothDesc"] = "Smooth passenger stairs leading outside and down, 2 m. It connects automatically to nearby platforms or exits.",
			["AxialPassengerStairsDownSteepName"] = "Exit with steep passenger stairs down",
			["AxialPassengerStairsDownSteepDesc"] = "Steep passenger stairs leading outside and down, 2 m. It connects automatically to nearby platforms or exits.",
			["AxialFlushCargoExitName"] = "Flush cargo exit, platform end",
			["AxialFlushCargoExitDesc"] = "Flush cargo exit at a platform end. It can connect to nearby similar exits, roads, stairs and lift assets.",
			["AxialPassengerStairsEdgeName"] = "Entrance to platform end with auto bridge",
			["AxialPassengerStairsEdgeDesc"] = "Connects a platform end to the road network. Link it to \"stairs\" assets, bridges or paths as required. It will become snappy at the next config update.",
			["AxialPassengerStairsSnappyEdgeName"] = "Entrance to platform end with snappy auto bridge",
			["AxialPassengerStairsSnappyEdgeDesc"] = "Connects a platform end to the road network. Link it to \"stairs\" assets, bridges or paths as required.",
			...
			["FlatPassengerStairsEdgeDesc"] = "Connects a platform side to the road network. Adjust its height with <m> and <n>. Link it to \"stairs\" assets, bridges or paths as required. It will become snappy at the next config update.",
			["FlatPassengerStairsSnappyEdgeName"] = "Entrance to platform side with snappy auto bridge",
			["FlatPassengerStairsSnappyEdgeDesc"] = "Connects a platform side to the road network. Adjust its height with <m> and <n>. Link it to \"stairs\" assets, bridges or paths as required.",
			...
			["FlushPassengerExitInnerDesc"] = "Flush passenger exit along the platform that ignores extensions, to make connections across overlapping extensions. Adjust its height with <m> and <n>. It connects automatically to nearby platforms or exits.",
