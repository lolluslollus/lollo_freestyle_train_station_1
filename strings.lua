function data()
	...
	return {
		en = {
			...
			["OpenLiftDesc"] = "Connects ground passenger platforms to their twins, to nearby bridge underpasses or, if you add an exit, to the outside world.",
            ["OpenStairsUpLeftName"] = "Stairs up left for ground platform",
			["OpenStairsUpLeftDesc"] = "Connects ground passenger platforms to their twins, to nearby bridge underpasses or, if you add an exit, to the outside world.",
			["OpenStairsUpRightName"] = "Stairs up right for ground platform",
			["OpenStairsUpRightDesc"] = "Connects ground passenger platforms to their twins, to nearby bridge underpasses or, if you add an exit, to the outside world.",
