function data()
	...
	return {
		en = {
			...
			["OpenLiftFreeDesc"] = "Lift matching the freestyle stations, collision free; use fences or similar mods to fine-tune collisions. You can combine this to pedestrian bridges or paths.",
			["OpenLiftFreeName"] = "Lift",
			["OpenStairsFreeDesc"] = "Stairs matching the freestyle stations, collision free; use fences or similar mods to fine-tune collisions. You can combine this to pedestrian bridges or paths.",
