function data()
	return {
		en = {
			...
			["FlatPassengerStation5MDesc"] = "Small passenger station, to access a platform higher than the road",
			["PassengerLiftName"] = "Passenger lift to a bridge",
			["PassengerLiftDesc"] = "Passenger lift to access a platform on a bridge",
			...
			["PassengerPlatform5MTracksDesc"] = "Passenger Platforms to Be Laid as Tracks, 5 m wide. Use them at tunnel entrances or on bridges. Outside stations, you must add the pedestrian lane yourself, for example with an ultrathin path, because they are, in fact, slow train tracks.",
			["PassengerPlatform2_5MTracksName"] = "2.5 m Passenger Platforms",
			["PassengerPlatform2_5MTracksDesc"] = "Passenger Platforms to Be Laid as Tracks, 2.5 m wide. The best choice for stations on ground. Outside stations, you must add the pedestrian lane yourself, for example with an ultrathin path, because they are, in fact, slow train tracks.",
