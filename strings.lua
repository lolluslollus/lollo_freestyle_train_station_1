function data()
	return {
		en = {
			...
			["OpenStairsExitWithEdgeName_2m"] = "Entrance to stairs with auto bridge, 2 m",
            ...
            ["OpenStairsExitDesc"] = "Connect stairs to the outside. Adjust the tilt with <m> and <n>. Link with \"stairs\" assets if required.",
			["OpenStairsExitWithEdgeDesc"] = "Connect stairs to the outside. Adjust the tilt with <m> and <n>. Link with \"stairs\" assets, bridges or paths if required.",
			...
			["StairsBaseTooltip"] = "It might be easier to select \"Auto Path\" when building and change it to \"Auto Bridge\" once built",
