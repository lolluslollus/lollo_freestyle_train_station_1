	...
	return {
		en = {
			["DESC"] = [[
				...
				- Upgrading tracks works meh; it stopped working for stock stations and for this as of late. To upgrade them, remove one terminal, wait until the mod has redrawn the tracks, then upgrade them, then redo your terminal with the markers.
			...
			["OpenStairsExitWithEdgeDesc"] = "Connects stairs to the road network. Adjust its tilt with <m> and <n>. Link it to \"stairs\" assets, bridges or paths as required. It will become snappy at the next config update.",
			["OpenStairsExitWithSnappyEdgeDesc"] = "Connects stairs to the road network. Adjust its tilt with <m> and <n>. Link it to \"stairs\" assets, bridges or paths as required.",
			["PassengerSideLiftName"] = "Passenger lift to a bridge side",
			["PassengerSideLiftDesc"] = "Passenger lift to access a platform on a bridge, from the side. It connects to underpasses if they are close enough. Max height 40 m, adjust it with <m> and <n>. Repaint its ground with <shift> and a paint tool.",
			["PassengerPlatformLiftName"] = "Passenger lift to a bridge",
			["PassengerPlatformLiftDesc"] = "Passenger lift to access a platform on a bridge, from below. It connects to underpasses if they are close enough. Max height 40 m, adjust it with <m> and <n>. Repaint its ground with <shift> and a paint tool.",
