function data()
	return {
		en = {
			...
			["PassengerPlatform5MTracksDesc"] = "Passenger Platforms to Be Laid as Tracks, 5 m wide. Use them at tunnel entrances, to make the ends meet. Outside stations, you must add the pedestrian lane yourself, for example with an ultrathin path.",
