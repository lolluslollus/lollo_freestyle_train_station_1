function data()
	...
	return {
		en = {
			...
			["AxialPassengerStairsEdgeDesc"] = "Connects a platform end to the road network. Adjust its height with <m> and <n>. Link it to \"stairs\" assets, bridges or paths as required. It will become snappy at the next config update.",
			["AxialPassengerStairsSnappyEdgeName"] = "Entrance to platform end with snappy auto bridge",
			["AxialPassengerStairsSnappyEdgeDesc"] = "Connects a platform end to the road network. Adjust its height with <m> and <n>. Link it to \"stairs\" assets, bridges or paths as required.",
			...
			["WallTIronGlassCopperDesc"] = "Iron and glass wall for passenger platforms, also suitable for tunnels. Adjust slantness with <m> and <n>.",
			...
			["WallTiledName"] = "Tiled platform wall, older",
			["WallTiledDesc"] = "Tiled wall for passenger platforms, also suitable for tunnels. Adjust slantness with <m> and <n>.",
			["WallTiledWLargeStripesName"] = "Tiled platform wall, newer",
			["WallTiledWLargeStripesDesc"] = "Tiled wall for passenger platforms, also suitable for tunnels. Adjust slantness with <m> and <n>.",
			...
			["WallMetalGlassDesc"] = "Glass wall for passenger platforms, also suitable for tunnels. Adjust slantness with <m> and <n>.",
