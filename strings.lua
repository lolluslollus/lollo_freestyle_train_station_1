function data()
	...
	return {
		en = {
			...
			["FlatPassengerStairsEdgeDesc"] = "Connects platforms to the outside. Adjust its height with <m> and <n>. Link it to \"stairs\" assets, bridges or paths as required. It will become snappy at the next config update.",
			["FlatPassengerStairsSnappyEdgeName"] = "Entrance to platform with snappy auto bridge",
			["FlatPassengerStairsSnappyEdgeDesc"] = "Connects platforms to the outside. Adjust its height with <m> and <n>. Link it to \"stairs\" assets, bridges or paths as required.",
			...
			["OpenLiftDesc"] = "Connects ground passenger platforms to their twins or to the outside world.",
			...
			["OpenStairsUpRightDesc"] = "Connects ground passenger platforms to their twins or to the outside world.",
            ...
            ["OpenStairsExitDesc"] = "Connects stairs to the outside. Adjust its tilt with <m> and <n>. Link it to \"stairs\" assets if required.",
			["OpenStairsExitWithEdgeDesc"] = "Connects stairs to the outside. Adjust its tilt with <m> and <n>. Link it to \"stairs\" assets, bridges or paths as required. It will become snappy at the next config update.",
			["OpenStairsExitWithSnappyEdgeDesc"] = "Connects stairs to the outside. Adjust its tilt with <m> and <n>. Link it to \"stairs\" assets, bridges or paths as required.",
			...
			["UnderpassStairsDesc"] = "Connects passenger platforms to the subway entrances and the other terminals.",
