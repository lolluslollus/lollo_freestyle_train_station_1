function data()
	...
	return {
		en = {
			...
			["TrackCrossingDesc"] = "It connects to one platform and it can connect to the road network or to a twin opposite. Crossing tracks is forbidden nowadays, which makes it interesting.",
			["TrackCrossingTwoStairsName"] = "Track crossing for a single track",
			["TrackCrossingTwoStairsDesc"] = "It tries to connect to two opposite platforms and it can connect to the road network. Crossing tracks is forbidden nowadays, which makes it interesting.",
