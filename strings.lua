function data()
	return {
		en = {
			...
			["CargoPlatformWaypointName"] = "Cargo Platform Marker",
			...
			["PassengerPlatformTracksDesc"] = "Passenger Platforms to Be Laid as Tracks",
			["PassengerPlatformWaypointName"] = "Passenger Platform Marker",
			...
			["TrackWaypointName"] = "Track Waypoint",
