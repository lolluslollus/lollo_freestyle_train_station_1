function data()
	...
	return {
		en = {
			...
			["FlushPassengerExitInnerDesc"] = "Flush passenger exit that ignores extensions. Adjust its height with <m> and <n>. It connects automatically to nearby platforms or exits.",
