function data()
	return {
		en = {
			...
			["PlatformEraASwitcherDesc"] = "Switch a platform style to era A",
			["PlatformEraBSwitcherName"] = "Switch platform to era B",
			["PlatformEraBSwitcherDesc"] = "Switch a platform style to era B",
			["PlatformEraCSwitcherName"] = "Switch platform to era C",
			["PlatformEraCSwitcherDesc"] = "Switch a platform style to era C",
