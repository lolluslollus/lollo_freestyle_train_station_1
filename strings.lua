...
- Some track and signal mods are incompatible. As a general rule, avoid mods that overwrite or disable stock game tracks. Chances are you won't miss them anyway.
			...
			["FenceWaypointDesc"] = "Marks the ends of a fence that will be drawn along a track. The direction of the second marker sets the side the fence will be on. Click the fence to configure it.",
...
- Einige Gleis- und Signalmods sind nicht kompatibel. Generell gilt: Vermeiden Sie Mods, die die Originalgleise des Spiels überschreiben oder deaktivieren. Wahrscheinlich werden Sie sie ohnehin nicht vermissen.
			...
			["WallBricksName"] = "Backsteinwand",
			["WallBricksDesc"] = "Backsteinwand, auch für Tunnel geeignet. Stützwand mit <m> und <n> einstellen.",
			...
			["WallFenceMattoniName"] = "Backsteinwand",
			["WallFenceMattoniDesc"] = "Backsteinwand, auch für Tunnels geeignet. Stützwand mit <m> und <n> einstellen.",
			...
			["WallTunnelyName"] = "Raue Backsteinwand mit Bögen",
			["WallTunnelyDesc"] = "Raue Backsteinwand mit Bögen, auch für Tunnels geeignet. Stützwand mit <m> und <n> einstellen.",
