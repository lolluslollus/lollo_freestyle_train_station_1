...
- Some track and signal mods are incompatible. As a general rule, avoid mods that overwrite or disable stock game tracks. Chances are you won't miss them anyway.
			...
			["AxialFlushCargoExitDesc"] = "Flush cargo exit at a platform end. It is purely eye candy. Tilt with <m> and <n>.",
			...
			["AxialFlushPassengerExitDesc"] = "Flush passenger exit at the platform end. It is purely eye candy. Tilt with <m> and <n>.",
...
- Einige Gleis- und Signalmods sind nicht kompatibel. Generell gilt: Vermeiden Sie Mods, die die Originalgleise des Spiels überschreiben oder deaktivieren. Wahrscheinlich werden Sie sie ohnehin nicht vermissen.
			...
			["AxialFlushCargoExitDesc"] = "Bündiger Frachtausgang an einem Bahnsteigende. Es ist reines eye candy. Kippt mit <m> und <n>.",
			...
			["AxialFlushPassengerExitDesc"] = "Bündiger Passagierausstieg am Bahnsteigende. Es ist reines eye candy. Kippt mit <m> und <n>.",
