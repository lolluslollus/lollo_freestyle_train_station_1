function data()
	...
	return {
		en = {
			...
			["FlatPassengerStairsEdgeDesc"] = "Connects platforms to the outside. Adjust its height with <m> and <n>. Link it to \"stairs\" assets, bridges or paths as required.",
			...
			["OpenStairsExitWithEdgeDesc"] = "Connects stairs to the outside. Adjust its tilt with <m> and <n>. Link it to \"stairs\" assets, bridges or paths as required.",
