function data()
	return {
		en = {
			...
			["PassengerSideLiftDesc"] = "Passenger lift to access a platform on a bridge, from the side",
			["PassengerPlatformLiftName"] = "Passenger lift to a bridge",
			["PassengerPlatformLiftDesc"] = "Passenger lift to access a platform on a bridge, from below",
