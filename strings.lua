function data()
	...
	return {
		en = {
			...
			["FlatPassengerStairsDownSmoothDesc"] = "Smooth passenger stairs leading outside and down, 2 m. Adjust their height with <m> and <n>. It connects automatically to nearby platforms or exits.",
			["FlatPassengerStairsDownSteepName"] = "Exit with steep passenger stairs down",
			["FlatPassengerStairsDownSteepDesc"] = "Steep passenger stairs leading outside and down, 2 m. Adjust their height with <m> and <n>. It connects automatically to nearby platforms or exits.",
			...
			["FlatPassengerStairsFlatDesc"] = "Flat passenger exit, 2 m. Adjust its height with <m> and <n>. It connects automatically to nearby platforms or exits.",
			...
			["FlushPassengerExitInnerDesc"] = "Flush passenger exit that ignores extensions, to make connections across overlapping extensions. Adjust its height with <m> and <n>. It connects automatically to nearby platforms or exits.",
			["FlushPassengerExitOuterName"] = "Flush passenger exit",
			["FlushPassengerExitOuterDesc"] = "Flush passenger exit along the platform or the extension border, whichever is farther. Adjust its height with <m> and <n>. It connects automatically to nearby platforms or exits.",
