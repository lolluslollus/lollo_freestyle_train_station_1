...
- Some track and signal mods are incompatible. As a general rule, avoid mods that overwrite or disable stock game tracks. Chances are you won't miss them anyway.
			...
			["FenceWaypointDesc"] = "Marks the ends of a fence/wall that will be drawn along a track. The direction of the second marker sets the side the fence will be on. Click the fence/wall to configure it.",
...
- Einige Gleis- und Signalmods sind nicht kompatibel. Generell gilt: Vermeiden Sie Mods, die die Originalgleise des Spiels überschreiben oder deaktivieren. Wahrscheinlich werden Sie sie ohnehin nicht vermissen.
			...
			["WaypointsCrossSignal"] = "Zwischen dieser Markierung und ihrem Zwilling befindet sich ein Signal oder ein Wegpunkt, oder zu nahe an einem von beiden",
			["WaypointsCrossStation"] = "Sie können eine bestehende Station nicht kreuzen",
			["WaypointDistanceWindowTitle"] = "Luftentfernung",
			["WaypointsNotConnected"] = "Dieser Marker ist nicht mit seinem Zwilling verbunden, oder es liegt ein Bahnhof/Verbindung/Signalmast dazwischen, oder er ist zu nahe an einem Bahnhof/Verbindung/Signalmast",
