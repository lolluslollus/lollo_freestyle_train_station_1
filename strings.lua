	...
	return {
		en = {
			["DESC"] = [[
				...
				- Upgrading tracks works meh; it stopped working for stock stations and for this as of late. To upgrade them, remove one terminal, wait until the mod has redrawn the tracks, then upgrade them (now you can), then redo your terminal with the markers.
