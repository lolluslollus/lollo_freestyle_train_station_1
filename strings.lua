...
- Einige Gleis- und Signalmods sind nicht kompatibel. Generell gilt: Vermeiden Sie Mods, die die Originalgleise des Spiels überschreiben oder deaktivieren. Wahrscheinlich werden Sie sie ohnehin nicht vermissen.
			...
			["WallConcreteModernDesc"] = "Betonmauer, auch für Tunnels geeignet. Stützwand mit <m> und <n> einstellen.",
			["WallConcretePlainName"] = "Betonwand, schlicht",
			["WallConcretePlainDesc"] = "Betonmauer, auch für Tunnels geeignet. Stützwand mit <m> und <n> einstellen.",
