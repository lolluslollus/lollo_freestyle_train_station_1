...
- After a while or after terraforming, the objects surrounding your station might throw collision errors whenever you try to configure the station. This is an old game problem and it happens with other stations, too. To get past it, start removing pedestrian bridges that snap into the station and add them back once you are done. If this does not help, do the same with adjoining tracks. If you still have no luck, patiently look for the guilty street, building or asset and remove it, then add it back once you are done.
			...
			["OpenStairsExitName_20m"] = "Entrance to stairs, 20 m",
			["OpenStairsExitName_24m"] = "Entrance to stairs, 24 m",
			["OpenStairsExitName_28m"] = "Entrance to stairs, 28 m",
			...
			["OpenStairsExitWithEdgeDesc"] = "Connects stairs and lifts to the road network. Adjust its tilt with <m> and <n>. Link it to \"stairs\" assets, bridges or paths as required. Leave a bit of slack between this and external stairs or lifts, maybe with the Construction Mover.",
			...
			["WallArcoConcreteRoughName"] = "Concrete wall with arches",
			["WallArcoConcreteRoughDesc"] = "Concrete wall with arches. On ground along the tracks, add/remove supporting wall with <m> and <n>.",
			["WallArcoConcreteRoughLightName"] = "Light concrete wall with arches",
			["WallArcoConcreteRoughLightDesc"] = "Light concrete with arches. On ground along the tracks, add/remove supporting wall with <m> and <n>.",
			...
			["WallConcreteLightPlainName"] = "Light concrete wall, plain",
			...
			["WallConcreteRoughLightName"] = "Concrete wall, rough, light",
			...
			["WallTiledName"] = "Tiled wall",
			["WallTiledDesc"] = "Tiled wall. On ground along the tracks, add/remove supporting wall with <m> and <n>.",
			["WallTiledGreenName"] = "Green tiled wall",
			["WallTiledGreenDesc"] = "Green tiled wall. On ground along the tracks, add/remove supporting wall with <m> and <n>.",
			["WallTiledWLargeStripesName"] = "Blue tiled wall",
			["WallTiledWLargeStripesDesc"] = "Blue tiled wall. On ground along the tracks, add/remove supporting wall with <m> and <n>.",
			...
			["ConConfigWindowTitle"] = "Settings for ",
			["DifferentPlatformWidths"] = "Avoid different track widths with cargo stations",
			["ErrorAddingTerminal"] = "Error adding terminal. Try manually removing neighbouring tracks or streets.",
			...
			["PathEraADefault"] = "Era A Path",
			["PathEraBDefault"] = "Era B Path",
			["PathEraCDefault"] = "Era C Path",
			...
			["Stairs"] = "Stairs, lifts, assets for the Freestyle Train Station",
			["StairsBase"] = "Expand Base",
			["Subways"] = "Underground entrances for the Freestyle Train Station",
			...
			-- fence assets
			["AutoBaseWallMarkerName"] = "Base wall end marker",
			["AutoBaseWallMarkerDesc"] = "Marks the first and last bits of track, along which a base wall will be built. The direction of the second marker sets the side of the wall. Once done, click the wall to configure it.",
			["AutoBaseWallMarkerPreciseName"] = "Precise base wall end marker",
			["AutoBaseWallMarkerPreciseDesc"] = "Marks the ends of a base wall that will be built along a track. The direction of the second marker sets the side of the wall. Once done, click the wall to configure it.",
			...
			["baseWall_isSkewed"] = "Slant Wall",
			["baseWall_isThick"] = "Thick wall",
			["baseWall_onlyOn"] = "Build on",
			["baseWall_onlyOnBridges"] = "Bridges",
			["baseWall_onlyOnBridgesGround"] = "Bridges and ground",
			["baseWall_onlyOnGround"] = "Ground",
			["BaseWallWaypointDesc"] = "Marks the first and last bits of track, along which a base wall will be built. The direction of the second marker sets the side of the wall. Once done, click the wall to configure it. To work on stations, use the marker asset or the station configuration menu.",
			["BaseWallWaypointName"] = "Base wall end marker",
			["BaseWallWaypointPreciseDesc"] = "Marks the ends of a base wall that will be built along a track. The direction of the second marker sets the side of the wall. Once done, click the wall to configure it. To work on stations, use the marker asset or the station configuration menu.",
			["BaseWallWaypointPreciseName"] = "Precise base wall end marker",
			...
			["isDownToGround"] = "Down to the ground",
			...
			["Lower"] = "Lower",
			["Raise"] = "Raise",
			["TerrainExtraWidthName"] = "Extra terrain width m",
			["WallArcoConcreteRough"] = "Rough concrete wall",
			["WallArcoConcreteRoughLight"] = "Rough light concrete wall",
			...
			["wallModelName"] = "Wall type",
			["WallStoneBrown"] = "Brown stone wall",
			["WallStoneGrey"] = "Grey stone wall",
			["WallStoneOrange"] = "Orange stone wall",
...
- Nach einer Weile wird sich das Gebiet um Ihren Bahnhof herum entwickelt haben und möglicherweise Kollisionsfehler verursachen, wenn du versuchst, den Bahnhof zu konfigurieren. Dieses alte Problem betrifft auch andere Bahnhöfe. Suche geduldig erst nach der schuldigen Straße, dann nach dem Gleis, dann nach dem Gebäude oder der Anlage und entferne sie.
			...
			["OpenStairsExitName_20m"] = "Eingang zur Treppe, 20 m",
			["OpenStairsExitName_24m"] = "Eingang zur Treppe, 24 m",
			["OpenStairsExitName_28m"] = "Eingang zur Treppe, 28 m",
			...
			["OpenStairsExitWithEdgeDesc"] = "Verbindet Treppen und Aufzüge mit dem Straßennetz. Passe seine Neigung mit <m> und <n> an. Verknüpfe sie je nach Bedarf mit Treppen, Brücken oder Wegen. Baue externe Treppen oder Aufzüge nicht zu dicht daran, evlt entferne sie ein Bisschen mit dem Construction Mover.",
			...
			["WallArcoConcreteRoughName"] = "Zementwand mit Bögen",
			["WallArcoConcreteRoughDesc"] = "Zementwand mit Bögen. Auf Erdboden entlang der Gleise, Stützwand mit <m> und <n> einstellen.",
			["WallArcoConcreteRoughLightName"] = "Helle Zementwand mit Bögen",
			["WallArcoConcreteRoughLightDesc"] = "Helle Zementwand mit Bögen. Auf Erdboden entlang der Gleise, Stützwand mit <m> und <n> einstellen.",
			...
			["WallConcreteLightPlainName"] = "Helle Betonwand, schlicht",
			...
			["WallConcreteRoughLightName"] = "Betonwand, rau, hell",
			...
			["WallTiledName"] = "Geflieste Wand",
			["WallTiledDesc"] = "Geflieste Wand. Auf Erdboden entlang der Gleise, Stützwand mit <m> und <n> einstellen.",
			["WallTiledGreenName"] = "Grüne geflieste Wand",
			["WallTiledGreenDesc"] = "Grüne geflieste Wand. Auf Erdboden entlang der Gleise, Stützwand mit <m> und <n> einstellen.",
			["WallTiledWLargeStripesName"] = "Blaue geflieste Wand",
			["WallTiledWLargeStripesDesc"] = "Blaue geflieste Wand. Auf Erdboden entlang der Gleise, Stützwand mit <m> und <n> einstellen.",
			...
			["ConConfigWindowTitle"] = "Einstellungen für ",
			["DifferentPlatformWidths"] = "Vermeide unterschiedliche Gleisbreiten bei Frachtbahnhöfen",
			["ErrorAddingTerminal"] = "Fehler beim Hinzufügen eines Terminals. Versuch benachbarte Gleise oder Strassen manuell zu entfernen.",
			...
			["PathEraADefault"] = "Epoche A Pfad",
			["PathEraBDefault"] = "Epoche B Pfad",
			["PathEraCDefault"] = "Epoche C Pfad",
			...
			["Stairs"] = "Treppen, Aufzüge, Assets für den Freestyle-Bahnhof",
			["StairsBase"] = "Basis ausbauen",
			["Subways"] = "Unterirdische Eingänge für den Freestyle-Bahnhof",
			...
			-- Zaun-Assets
			["AutoBaseWallMarkerName"] = "Untermauermarker",
			["AutoBaseWallMarkerDesc"] = "Markiert das erste und letze Gleisstück, entlang deren eine Untermauer gebaut wird. Die Richtung des zweiten Markers setzt die Seite fest, wo die Wand entsteht. Klicke dann darauf, um die Wand zu konfigurieren.",
			["AutoBaseWallMarkerPreciseName"] = "Präziser Untermauermarker",
			["AutoBaseWallMarkerPreciseDesc"] = "Markiert die Enden einer Untermauer, die entlang eines Gleises gebaut wird. Die Richtung des zweiten Markers setzt die Seite fest, wo die Wand entsteht. Klicke dann darauf, um die Wand zu konfigurieren.",
			...
			["baseWall_isSkewed"] = "Schräge Wand",
			["baseWall_isThick"] = "Dicke Wand",
			["baseWall_onlyOn"] = "Bauen auf",
			["baseWall_onlyOnBridges"] = "Brücken",
			["baseWall_onlyOnBridgesGround"] = "Brücken und Boden",
			["baseWall_onlyOnGround"] = "Boden",
			["BaseWallWaypointDesc"] = "Markiert das erste und letze Gleisstück, entlang deren eine Untermauer gebaut wird. Die Richtung des zweiten Markers setzt die Seite fest, wo die Mauer entsteht. Klicke dann darauf, um den Zaun zu konfigurieren. Um in Bahnhöfen zu arbeiten, verwende mein Marker-Asset oder das Bahnhof-Konfigurationsmenü.",
			["BaseWallWaypointName"] = "Untermauermarker",
			["BaseWallWaypointPreciseDesc"] = "Markiert die Enden einer Untermauer, die entlang eines Gleises gebaut wird. Die Richtung des zweiten Markers setzt die Seite fest, wo die Mauer entsteht. Klicke dann darauf, um die Mauer zu konfigurieren. Um in Bahnhöfen zu arbeiten, verwende mein Marker-Asset oder das Bahnhof-Konfigurationsmenü.",
			["BaseWallWaypointPreciseName"] = "Präziser Untermauermarker",
			...
			["Lower"] = "Senken",
			["Raise"] = "Heben",
			["TerrainExtraWidthName"] = "Extra Bodenbreite, m",
			["WallArcoConcreteRough"] = "Raue Zementwand",
			["WallArcoConcreteRoughLight"] = "Raue helle Zementwand",
			...
			["wallModelName"] = "Wandtyp",
			["WallStoneBrown"] = "Braune Steinmauer",
			["WallStoneGrey"] = "Graue Steinmauer",
			["WallStoneOrange"] = "Sandsteinmauer",
