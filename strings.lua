function data()
	return {
		en = {
			...
			["TunnelStairsUpName"] = "Stairs up",
			["TunnelStairsUpDesc"] = "Plop these on underground passenger platforms, to connect them to the subways and the other terminals above.",
			["TunnelStairsUpDownName"] = "Stairs up and down",
			["TunnelStairsUpDownDesc"] = "Plop these on underground passenger platforms, to connect them to the subways and the other terminals above and below.",
